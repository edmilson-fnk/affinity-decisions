...
public class Lists {
	...
	public static Deck affinity() {
		...
		deckList.addAll(Utils.createCard(CardName.ETCHED_CHAMPION, CardClassification.BOMB_2, 2));
		deckList.addAll(Utils.createCard(CardName.MASTER_ETHERIUM, CardClassification.BOMB_2, 2));
...
//		deckList.addAll(Utils.createCard(CardName.WELDING_JAR, CardClassification.COST_0, 2));
		...
		deckList.addAll(Utils.createCard(CardName.GALVANIC_BLAST, CardClassification.COST_1, 4));
		deckList.addAll(Utils.createCard(CardName.MOX_OPAL, CardClassification.MANA_SOURCE_M, 4));
		deckList.addAll(Utils.createCard(CardName.SPRINGLEAF_DRUM, CardClassification.MANA_SOURCE_M, 4));
